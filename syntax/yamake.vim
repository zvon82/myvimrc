...
syn keyword yamakeProject skipwhite nextgroup=yamakeArguments
            \ PROGRAM PY2_PROGRAM PY3_PROGRAM JAVA_PROGRAM GO_PROGRAM TOOL
            \ LIBRARY PY2_LIBRARY PY23_LIBRARY JAVA_LIBRARY GO_LIBRARY PROTO_LIBRARY FAT_OBJECT
            \ DLL PYMODULE
            \ UNITTEST UNITTEST_FOR PY2TEST PYTEST_SCRIPT EXECTEST JTEST JTEST_FOR
            \ PY23_TEST PY3TEST
            \ BENCHMARK FUZZ
